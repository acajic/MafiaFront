app.directive('residentBecameSheriffResult', function(actionResultsService) {
    "use strict";
    return {
        restrict : 'E',
        ...
        link: function(scope, element, attrs) {
            ...
            scope.$watch('[actionResult, city]', function(values) {
                ...
                scope.interpretation = "Sheriff has died and you became the new Sheriff. Congratulations!";
